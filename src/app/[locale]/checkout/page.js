                      ...
                      <div class="space-y-4">
                          <div class="flex items-start gap-4 max-sm:flex-col">
                              <div class="w-[70px] h-[70px] bg-gray-200 rounded-lg flex items-center justify-center shrink-0">
                                  <Image src="https://readymadeui.com/images/watch1.webp" alt="Product" class="w-14 h-14 object-contain rounded-sm" />
                              </div>
                              <div class="flex-1">
                          ...
                          <div class="flex items-start gap-4 max-sm:flex-col max-sm:border-t max-sm:pt-4 max-sm:border-gray-300">
                              <div class="w-[70px] h-[70px] bg-gray-200 rounded-lg flex items-center justify-center shrink-0">
                                  <Image src="https://readymadeui.com/images/product14.webp" alt="Product" class="w-14 h-14 object-contain rounded-sm" />
                              </div>
                              <div class="flex-1">
