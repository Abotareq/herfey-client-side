            ...
            <div className="bg-gray-50 rounded-xl p-4 h-48 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">
                  Using Google Maps, Mapbox, or similar service
                </p>
              </div>
            </div>
    ...
    <div>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* Hero Section */}
          <div
            className={`bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mb-8 transition-all duration-700 ${
              isVisible
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span>
                            ID:{" "}
                            {storeData._id?.slice(-8) ||
                              storeData.id?.slice(-8)}
                          </span>
                        </div>
                        <div className="flex items-center gap-1">
            ...
            {[
              {
                icon: Package,
                label: "Products",
                value: storeData.productCount || 0,
                color: "orange",
              },
              {
                icon: ShoppingBag,
                label: "Orders",
                value: storeData.ordersCount || 0,
                color: "green",
              },
              {
                icon: Star,
                label: "Categories",
                value: storeData.categorieCount || 0,
                color: "blue",
              },
              {
                icon: Users,
                label: "Coupons Used",
                value: storeData.couponsUsed || 0,
                color: "purple",
              },
            ].map((stat, index) => (
              <div
                key={index}
                className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 transition-all duration-500 hover:shadow-md ${
                  isVisible
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-4"
                }`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* Store Policies */}
            <div
              className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 transition-all duration-700 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-4"
              }`}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        {storeData.policies?.shipping ||
                          "No shipping policy specified"}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="text-gray-900 font-medium">
                      {storeData.address?.postalCode || "N/A"}
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Store Information */}
          <div
            className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8 transition-all duration-700 ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-4"
            }`}
          ...
          {/* Call to Action */}
          <div
            className={`bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-lg p-8 text-center text-white transition-all duration-700 ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-4"
            }`}
          ...
          >
            ...
            <button
              ...
              onClick={() => {
                handleBrowseStoreProducts(storeData._id);
              }}
            >
              Browse Products
            </button>
