...
const Input = ({ ...props }) => {
  return (
    <input
      className="w-full bg-gray-700 bg-opacity-50 text-white rounded-lg border border-gray-600 focus:ring-2 focus:ring-orange-500 focus:border-transparent px-4 py-2 transition duration-300"
      {...props}
    />
  );
};
