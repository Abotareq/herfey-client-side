      ...
      <div className="mb-8 animate-pulse">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex gap-3">
            <div className="skeleton h-10 rounded-lg w-24"></div>
            <div className="skeleton h-10 rounded-lg w-24"></div>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-4">
          ...
          <div className="skeleton h-12 rounded-xl w-40"></div>
          <div className="skeleton h-12 rounded-xl w-48"></div>
        </div>
      </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <div className="skeleton h-8 rounded w-12"></div>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 animate-pulse">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="skeleton h-9 rounded w-16"></div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl p-5 shadow-xs">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-gray-900/8">
                      <div className="skeleton h-4 rounded w-24"></div>
                      <div className="bg-orange-600 h-6 rounded w-24"></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-5 shadow-xs">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="skeleton w-4 h-4 rounded"></div>
                    <div className="skeleton h-5 rounded w-28"></div>
                  </div>
                  <div className="flex flex-col gap-3">
                    <div className="skeleton h-9 rounded-lg"></div>
                    <div className="bg-orange-600 h-9 rounded-lg"></div>
                    <div className="skeleton p-2 rounded-lg">
                      <div className="skeleton h-4 rounded w-32"></div>
                    </div>
                  </div>
                </div>
      ...
      <div className="bg-white rounded-xl shadow-sm mt-8 p-6 animate-pulse">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="skeleton h-8 rounded w-16"></div>
            <div className="skeleton h-8 rounded w-12"></div>
          </div>
        </div>
      </div>
