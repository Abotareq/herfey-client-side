    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        {[1, 2, 3, 4].map((index) => (
          <div
            key={index}
            className="bg-white rounded-3xl border border-orange-100 shadow-lg overflow-hidden animate-pulse"
            style={{ animationDelay: `${index * 100}ms` }}
          >
            {/* Store Header Skeleton */}
            <div className="bg-gradient-to-br from-gray-200 to-gray-300 p-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-5">
                  {/* Logo Skeleton */}
                  <div className="w-20 h-20 bg-gray-400 rounded-2xl"></div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 bg-gray-400 rounded-xl"></div>
                  <div className="w-11 h-11 bg-gray-400 rounded-xl"></div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {[1, 2, 3, 4].map((statIndex) => (
                  ...
                  >
                    <div className="w-12 h-12 bg-gray-200 rounded-2xl mx-auto mb-3 animate-pulse"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-slate-100">
                <div className="flex-1 h-14 bg-gray-200 rounded-2xl animate-pulse"></div>
                <div className="flex-1 h-14 bg-gray-200 rounded-2xl animate-pulse"></div>
              </div>
            </div>
          </div>
...
export function StoreSkeletonSimple() {
  return (
    <div className="space-y-8">
      {/* Header Skeleton */}
      <div className="flex justify-between items-center pb-6 border-b border-orange-100">
