  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 pb-8 border-b border-gray-900/8">
        ...
        <div className="skeleton h-14 rounded-2xl w-48"></div>
      </div>
            ...
            <div className="bg-orange-600 p-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-5">
                  ...
                  <div className="space-y-3">
                    <div className="bg-orange-600 h-6 rounded w-32"></div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {[1, 2, 3, 4].map((statIndex) => (
                  ...
                  >
                    ...
                    <div className="skeleton h-3 rounded w-16 mx-auto"></div>
                  </div>
                ))}
              </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center pb-6 border-b border-gray-900/8">
        ...
        <div className="skeleton h-12 rounded-2xl w-40"></div>
      </div>
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1">
                <div className="skeleton h-5 rounded w-3/4 mb-2"></div>
            ...
            <div className="flex gap-2 mt-4">
              <div className="skeleton flex-1 h-8 rounded"></div>
              <div className="skeleton flex-1 h-8 rounded"></div>
            </div>
          </div>
        ))}
