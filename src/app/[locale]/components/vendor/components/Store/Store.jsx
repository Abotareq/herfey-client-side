  ...
  if (loading) {
    return (
      <div className="space-y-8 animate-fade-in">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-orange-100">
          <div className="space-y-2">
              ...
              <div className="space-y-8">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full px-5 py-4 border-2 border-slate-200 rounded-2xl focus:ring-4 focus:ring-orange-200 focus:border-orange-400 transition-all duration-300 hover:border-slate-300 text-lg font-medium"
                    placeholder={t('storename')}
                  />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-5 py-4 border-2 border-slate-200 rounded-2xl focus:ring-4 focus:ring-orange-200 focus:border-orange-400 transition-all duration-300 hover:border-slate-300 resize-none text-lg"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-200 focus:border-orange-400 transition-all duration-300"
                        placeholder="-74.0060"
                      />
                    </div>
                    <div className="space-y-2">
