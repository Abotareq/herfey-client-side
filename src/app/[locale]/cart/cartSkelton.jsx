      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <div className="skeleton h-4 rounded-lg w-32"></div>
          </div>
          <div className="skeleton h-10 rounded-lg w-48"></div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 lg:gap-8 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-xs p-6 h-fit sticky top-8">
            {/* Title */}
            <div className="skeleton h-6 rounded-lg w-32 mb-6"></div>
            ...
            <div className="space-y-4 mb-6">
              ...
              {/* Total */}
              <div className="border-t border-gray-900/8 pt-4">
                <div className="flex justify-between items-center">
            ...
            <div className="mt-8 pt-6 border-t border-gray-900/8">
              <div className="skeleton h-4 rounded w-40 mx-auto mb-4"></div>
